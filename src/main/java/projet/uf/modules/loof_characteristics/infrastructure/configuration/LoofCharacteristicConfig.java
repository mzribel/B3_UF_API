package projet.uf.modules.loof_characteristics.infrastructure.configuration;

import org.springframework.context.annotation.Bean;
import org.springframework.context.annotation.Configuration;
import projet.uf.modules.loof_characteristics.adapters.out.persistence.LoofCharacteristicAdapter;
import projet.uf.modules.loof_characteristics.adapters.out.persistence.breed.BreedEntityMapper;
import projet.uf.modules.loof_characteristics.adapters.out.persistence.breed.JpaBreedRepository;
import projet.uf.modules.loof_characteristics.adapters.out.persistence.coat_color.CoatColorEntityMapper;
import projet.uf.modules.loof_characteristics.adapters.out.persistence.coat_color.JpaCoatColorRepository;
import projet.uf.modules.loof_characteristics.adapters.out.persistence.coat_effect.CoatEffectEntityMapper;
import projet.uf.modules.loof_characteristics.adapters.out.persistence.coat_effect.JpaCoatEffectRepository;
import projet.uf.modules.loof_characteristics.adapters.out.persistence.coat_pattern.CoatPatternEntityMapper;
import projet.uf.modules.loof_characteristics.adapters.out.persistence.coat_pattern.JpaCoatPatternRepository;
import projet.uf.modules.loof_characteristics.adapters.out.persistence.coat_white_marking.CoatWhiteMarkingEntityMapper;
import projet.uf.modules.loof_characteristics.adapters.out.persistence.coat_white_marking.JpaCoatWhiteMarkingRepository;
import projet.uf.modules.loof_characteristics.adapters.out.persistence.poly_types.JpaPolyTypeRepository;
import projet.uf.modules.loof_characteristics.adapters.out.persistence.poly_types.PolyTypeEntityMapper;
import projet.uf.modules.loof_characteristics.application.AllLoofCharacteristicsService;
import projet.uf.modules.loof_characteristics.application.LoofCharacteristicService;
import projet.uf.modules.loof_characteristics.application.mapper.*;
