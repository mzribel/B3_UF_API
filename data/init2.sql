...
--
-- Hôte : 127.0.0.1
-- Généré le : mar. 27 mai 2025 à 21:17
...
DROP
DATABASE IF EXISTS `breeders_app`;
CREATE
DATABASE IF NOT EXISTS `breeders_app`;
USE
`breeders_app`;
...
INSERT INTO `addresses` (`id`, `street`, `complement`, `postal_code`, `city`, `country`)
VALUES (1, 'Rue de la République', 'Résidence les Pélicans bât. B', '13130', 'Berre l\'Etang', NULL),
...
(1, 'Chatterie RathGate', NULL, 'RATHGATE\'S', 1, NULL, NULL, 1, 1, 0),
       ...
       (3, 'Chatterie des huit chemins', NULL, 'DES HUIT CHEMINS', 0, NULL, NULL, 1, 1, 0),
       (4, 'Chatterie de la terre de brasco', NULL, 'DE LA TERRE DE BRASCO', 0, NULL, NULL, 1, 1, 0);
...
INSERT INTO `breeds` (`id`, `code`, `name`, `details`)
VALUES (1, 'MCO', 'Maine Coon', NULL);
...
INSERT INTO `cats` (`id`, `name`, `surname`, `sex`, `birth_date`, `litter_id`, `origin_breeder_id`,
                    `current_breeder_id`, `breed_id`, `eye_color_id`, `poly_type_id`, `pedigree_no`,
                    `identification_no`, `is_neutered`, `neutered_date`, `is_deceased`, `deceased_date`,
                    `created_by_cattery_id`, `is_in_cattery`, `notes`)
VALUES (1, 'Serkhan', 'Ptit Loup', 0, '2021-07-05', NULL, 3, 2, 1, NULL, 1, 'LOOF 2021.40533', '250269590612101', 0,
        NULL, 0, NULL, 1, 1, NULL),
       (2, 'Salemm', NULL, 1, '2021-04-13', NULL, 4, 2, 1, NULL, 2, 'LOOF 2021.28950', '250268502119223', 0, NULL, 0,
        NULL, 1, 1, NULL),
       (3, 'Scarlett', NULL, 1, '2021-04-07', NULL, 4, NULL, 1, NULL, NULL, 'LOOF 2021.27416', '250268502119253', 1,
        NULL, 0, NULL, 1, 1, NULL),
       (4, 'Uranus', 'Bingus', 0, '2023-02-20', NULL, 2, 1, 1, NULL, NULL, 'LOOF 2023.14148', '250268780001262', 1,
        NULL, 0, NULL, 1, 1, NULL),
       (5, 'Teba', NULL, 0, NULL, NULL, 2, 1, 1, NULL, 1, 'LOOF 2022.51603', '2503268780001287', 1, NULL, 0, NULL, 1, 1,
        NULL);
...
INSERT INTO `catteries` (`id`, `created_by_user_id`, `linked_to_breeder_id`)
VALUES (1, 1, 1);
...
INSERT INTO `cat_coats` (`cat_id`, `base_color_id`, `pattern_id`, `effect_id`, `white_marking_id`)
VALUES (1, 4, NULL, NULL, NULL),
       (2, 1, NULL, NULL, NULL),
       (3, 16, 8, NULL, NULL),
       (4, 1, NULL, NULL, NULL),
       (5, 5, 8, NULL, NULL);
...
--
-- Déchargement des données de la table `coat_colors`
--

INSERT INTO `coat_colors` (`id`, `code`, `name`, `details`)
VALUES (1, 'n', 'noir', NULL),
       (2, 'b', 'chocolat', NULL),
       (3, 'o', 'cinnamon', NULL),
       (4, 'd', 'roux', NULL),
       (5, 'a', 'bleu', NULL),
...
INSERT INTO `coat_effects` (`id`, `code`, `name`, `details`)
VALUES (1, 's', 'silver', NULL),
       (2, 's', 'smoke', NULL),
       (3, 'u', 'copper', NULL),
       (4, 'u', 'sunshine', NULL),
       (5, 'y', 'golden', NULL),
...
INSERT INTO `coat_patterns` (`id`, `code`, `name`, `details`)
VALUES (1, '11', 'shaded', NULL),
       (2, '12', 'shell', NULL),
...
INSERT INTO `coat_white_markings` (`id`, `code`, `name`, `details`)
VALUES (1, '01', '& blanc van', NULL),
...
INSERT INTO `eye_colors` (`id`, `code`, `name`, `details`)
VALUES (1, '61', 'yeux bleus', NULL),
       (2, '62', 'yeux or', NULL),
...
(
    ...
    `kitten_movement`      bit(1) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(
    ...
    `first_wak_date` datetime DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `litters` (`id`, `dam_id`, `sire_id`, `origin_breeder_id`, `date_of_birth`, `loof_identification_number`,
                       `loof_declaration_date`, `kitten_count`, `notes`, `created_by_cattery_id`)
VALUES (1, 3, 1, 2, '2022-08-19 00:00:00', NULL, NULL, 4,
...
INSERT INTO `persons` (`id`, `sex`, `is_legal_person`, `first_name`, `last_name`, `date_of_birth`, `email`,
                       `phone_number`, `address_id`, `notes`)
VALUES (1, 1, 0, 'Marianne', 'Corbel', '1999-05-30', 'chatterie@rathgate.fr', '0645228103', 1, NULL),
...
INSERT INTO `poly_types` (`id`, `code`, `name`, `details`)
VALUES (1, 'P', 'polydactyle pattes avant', NULL),
...
INSERT INTO `users` (`id`, `email`, `password`, `display_name`, `is_admin`)
VALUES (1, 'chatterie@rathgate.fr', '$2a$10$leWAoXrr3cC4/ANAkF7EtOzM1E1ddD.8WMQymWmhP3HU0gvGBEffG',
        'Chatterie RathGate', 0),
       (2, 'mariannecorbel@hotmail.fr', '$2a$10$leWAoXrr3cC4/ANAkF7EtOzM1E1ddD.8WMQymWmhP3HU0gvGBEffG', 'mzribel', 1),
       (4, 'tony.dedonato@ynov.com', '$2a$10$pM39.Jlh8wTrJ8pjwt/NMeFonypBYJL2lv0swYnOZMXRnNgWMhCIO', 'tonyent', 1);
...
ALTER TABLE `breeders`
  ...
  ADD CONSTRAINT `breeders_ibfk_2` FOREIGN KEY (`created_by_cattery_id`) REFERENCES `catteries` (`id`) ON
DELETE
CASCADE;
...
ALTER TABLE `cats`
  ...
  ADD CONSTRAINT `cats_ibfk_2` FOREIGN KEY (`current_breeder_id`) REFERENCES `breeders` (`id`) ON
DELETE
SET NULL,
  ADD CONSTRAINT `cats_ibfk_3` FOREIGN KEY (`breed_id`) REFERENCES `breeds` (`id`) ON DELETE
SET NULL,
  ADD CONSTRAINT `cats_ibfk_4` FOREIGN KEY (`poly_type_id`) REFERENCES `poly_types` (`id`) ON DELETE
SET NULL,
  ADD CONSTRAINT `cats_ibfk_5` FOREIGN KEY (`eye_color_id`) REFERENCES `eye_colors` (`id`) ON DELETE
SET NULL,
  ADD CONSTRAINT `cats_ibfk_8` FOREIGN KEY (`created_by_cattery_id`) REFERENCES `catteries` (`id`) ON DELETE
CASCADE,
  ADD CONSTRAINT `fk_cats_litter_id` FOREIGN KEY (`litter_id`) REFERENCES `litters` (`id`) ON DELETE
SET NULL;
...
ALTER TABLE `catteries`
  ...
  ADD CONSTRAINT `fk_catteries_breeder_id` FOREIGN KEY (`linked_to_breeder_id`) REFERENCES `breeders` (`id`) ON
DELETE
SET NULL;
...
ALTER TABLE `cattery_users`
  ...
  ADD CONSTRAINT `cattery_users_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON
DELETE
CASCADE;
...
--
ALTER TABLE `cat_coats`
    ADD CONSTRAINT `cat_coats_ibfk_1` FOREIGN KEY (`base_color_id`) REFERENCES `coat_colors` (`id`) ON DELETE CASCADE,
  ...
  ADD CONSTRAINT `fk_coats_breeder_id` FOREIGN KEY (`cat_id`) REFERENCES `cats` (`id`) ON
DELETE
CASCADE;
...
ALTER TABLE `gestations`
  ...
  ADD CONSTRAINT `gestations_ibfk_1` FOREIGN KEY (`mating_id`) REFERENCES `matings` (`id`) ON
DELETE
SET NULL,
  ADD CONSTRAINT `gestations_ibfk_2` FOREIGN KEY (`dam_id`) REFERENCES `cats` (`id`) ON DELETE
CASCADE,
  ADD CONSTRAINT `gestations_ibfk_3` FOREIGN KEY (`sire_id`) REFERENCES `cats` (`id`) ON DELETE
SET NULL;
...
ALTER TABLE `litters`
  ...
  ADD CONSTRAINT `litters_ibfk_2` FOREIGN KEY (`sire_id`) REFERENCES `cats` (`id`) ON
DELETE
SET NULL,
  ADD CONSTRAINT `litters_ibfk_3` FOREIGN KEY (`origin_breeder_id`) REFERENCES `breeders` (`id`) ON DELETE
SET NULL,
  ADD CONSTRAINT `litters_ibfk_4` FOREIGN KEY (`created_by_cattery_id`) REFERENCES `catteries` (`id`) ON DELETE
CASCADE;
...
ALTER TABLE `matings`
  ...
  ADD CONSTRAINT `matings_ibfk_2` FOREIGN KEY (`sire_id`) REFERENCES `cats` (`id`) ON
DELETE
CASCADE,
  ADD CONSTRAINT `matings_ibfk_3` FOREIGN KEY (`heat_id`) REFERENCES `heats` (`id`) ON DELETE
SET NULL;
